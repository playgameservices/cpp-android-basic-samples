 ...
 */
JNIEXPORT void
Java_com_google_example_games_bc3_ButtonClickerNativeActivity_nativeOnActivityResult(
...
JNIEXPORT void
Java_com_google_example_games_bc3_ButtonClickerNativeActivity_nativeOnActivityCreated(
...
JNIEXPORT void
Java_com_google_example_games_bc3_ButtonClickerNativeActivity_nativeOnActivityDestroyed(
    JNIEnv *env, jobject thiz, jobject activity) {
  gpg::AndroidSupport::OnActivityDestroyed(env, activity);
}

JNIEXPORT void
Java_com_google_example_games_bc3_ButtonClickerNativeActivity_nativeOnActivityPaused(
    JNIEnv *env, jobject thiz, jobject activity) {
  gpg::AndroidSupport::OnActivityPaused(env, activity);
}

JNIEXPORT void
Java_com_google_example_games_bc3_ButtonClickerNativeActivity_nativeOnActivityResumed(
    JNIEnv *env, jobject thiz, jobject activity) {
  gpg::AndroidSupport::OnActivityResumed(env, activity);
}

JNIEXPORT void
Java_com_google_example_games_bc3_ButtonClickerNativeActivity_nativeOnActivitySaveInstanceState(
...
JNIEXPORT void
Java_com_google_example_games_bc3_ButtonClickerNativeActivity_nativeOnActivityStarted(
    JNIEnv *env, jobject thiz, jobject activity) {
  gpg::AndroidSupport::OnActivityStarted(env, activity);
}

JNIEXPORT void
Java_com_google_example_games_bc3_ButtonClickerNativeActivity_nativeOnActivityStopped(
    JNIEnv *env, jobject thiz, jobject activity) {
