 ...
 */
JNIEXPORT void
Java_com_google_example_games_tq2_TrivialQuestNativeActivity_nativeOnActivityResult(
...
JNIEXPORT void
Java_com_google_example_games_tq2_TrivialQuestNativeActivity_nativeOnActivityCreated(
...
JNIEXPORT void
Java_com_google_example_games_tq2_TrivialQuestNativeActivity_nativeOnActivityDestroyed(
    JNIEnv *env, jobject thiz, jobject activity) {
  gpg::AndroidSupport::OnActivityDestroyed(env, activity);
}

JNIEXPORT void
Java_com_google_example_games_tq2_TrivialQuestNativeActivity_nativeOnActivityPaused(
    JNIEnv *env, jobject thiz, jobject activity) {
  gpg::AndroidSupport::OnActivityPaused(env, activity);
}

JNIEXPORT void
Java_com_google_example_games_tq2_TrivialQuestNativeActivity_nativeOnActivityResumed(
    JNIEnv *env, jobject thiz, jobject activity) {
  gpg::AndroidSupport::OnActivityResumed(env, activity);
}

JNIEXPORT void
Java_com_google_example_games_tq2_TrivialQuestNativeActivity_nativeOnActivitySaveInstanceState(
...
JNIEXPORT void
Java_com_google_example_games_tq2_TrivialQuestNativeActivity_nativeOnActivityStarted(
    JNIEnv *env, jobject thiz, jobject activity) {
  gpg::AndroidSupport::OnActivityStarted(env, activity);
}

JNIEXPORT void
Java_com_google_example_games_tq2_TrivialQuestNativeActivity_nativeOnActivityStopped(
    JNIEnv *env, jobject thiz, jobject activity) {
