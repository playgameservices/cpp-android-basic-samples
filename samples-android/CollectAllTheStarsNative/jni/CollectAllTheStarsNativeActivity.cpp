 ...
 */
JNIEXPORT void
Java_com_google_example_games_catt3_CollectAllTheStarsNativeActivity_nativeOnActivityResult(
...
JNIEXPORT void
Java_com_google_example_games_catt3_CollectAllTheStarsNativeActivity_nativeOnActivityCreated(
...
JNIEXPORT void
Java_com_google_example_games_catt3_CollectAllTheStarsNativeActivity_nativeOnActivityDestroyed(
    JNIEnv *env, jobject thiz, jobject activity) {
  gpg::AndroidSupport::OnActivityDestroyed(env, activity);
}

JNIEXPORT void
Java_com_google_example_games_catt3_CollectAllTheStarsNativeActivity_nativeOnActivityPaused(
    JNIEnv *env, jobject thiz, jobject activity) {
  gpg::AndroidSupport::OnActivityPaused(env, activity);
}

JNIEXPORT void
Java_com_google_example_games_catt3_CollectAllTheStarsNativeActivity_nativeOnActivityResumed(
    JNIEnv *env, jobject thiz, jobject activity) {
  gpg::AndroidSupport::OnActivityResumed(env, activity);
}

JNIEXPORT void
Java_com_google_example_games_catt3_CollectAllTheStarsNativeActivity_nativeOnActivitySaveInstanceState(
...
JNIEXPORT void
Java_com_google_example_games_catt3_CollectAllTheStarsNativeActivity_nativeOnActivityStarted(
    JNIEnv *env, jobject thiz, jobject activity) {
  gpg::AndroidSupport::OnActivityStarted(env, activity);
}

JNIEXPORT void
Java_com_google_example_games_catt3_CollectAllTheStarsNativeActivity_nativeOnActivityStopped(
    JNIEnv *env, jobject thiz, jobject activity) {
