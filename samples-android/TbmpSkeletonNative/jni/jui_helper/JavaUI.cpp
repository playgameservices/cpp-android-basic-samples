...
JNIEXPORT void Java_com_sample_helper_JUIHelper_JUICallbackHandler(
    ...
    int32_t param2) {
  /*
   * id from Java is generated toekn, which could be mapped into an UI pointer
   * id is opaque to Java, so Java receives and return back the same id to us
   */
