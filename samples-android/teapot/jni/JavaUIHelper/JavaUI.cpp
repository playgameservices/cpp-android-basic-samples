...
JUIView::JUIView() :
        layoutWidth_( ATTRIBUTE_SIZE_WRAP_CONTENT ), layoutHeight_( ATTRIBUTE_SIZE_WRAP_CONTENT ), layoutWeight_( 0.f )
{
...
/*{ "ImeActionLabel", ATTRIBUTE_PARAMETER_STRING, ATTRIBUTE_PARAMETER_INT },*/
