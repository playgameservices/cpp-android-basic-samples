...
std::map<std::string, int32_t> JUIToast::map_attributes_;
ATTRIBUTE_TYPE JUIToast::attributes_[] =
{
{ "Duration", ATTRIBUTE_PARAMETER_INT },
{ "Gravity", ATTRIBUTE_PARAMETER_III },
{ "Margin", ATTRIBUTE_PARAMETER_FF },
...
void JUIToast::InitToast()
{
    ...
    jclass cls = ndk_helper::JNIHelper::GetInstance()->RetrieveClass( env, "android/widget/Toast" );
    ...
    obj_ = env->CallStaticObjectMethod( cls, mid, context, emptyString, 0 );
    obj_ = env->NewGlobalRef( obj_ );
    if( obj_ == NULL )
...
{
    ndk_helper::JNIHelper::GetInstance()->CallVoidMethod( obj_, "show", "(Landroid/view/View;)V", view->GetJobject() );
}
