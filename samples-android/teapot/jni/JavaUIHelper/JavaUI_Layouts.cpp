...
//Recreate Java Widget when the activity has been disposed
    ...
    while( itBegin != itEnd )
    {
        ...
        ndk_helper::JNIHelper::GetInstance()->CallVoidMethod( JUIWindow::GetHelperClassInstance(), "addView",
                "(Landroid/widget/LinearLayout;Landroid/view/View;)V", GetJobject(), (*itBegin)->GetJobject() );
...
{
    ndk_helper::JNIHelper::GetInstance()->CallVoidMethod( JUIWindow::GetHelperClassInstance(), "addView",
            "(Landroid/widget/LinearLayout;Landroid/view/View;)V", GetJobject(), view->GetJobject() );
